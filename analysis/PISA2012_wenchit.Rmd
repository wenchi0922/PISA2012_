...
2. PISA2012lite: original data set [@PISA2012] 

3. lme4: for linear regression analysis [@lme4]

4. magrittr: for specified functions such as %>% [@mag]

5. data.table: [@table]

6. dplyr: to enable select function [@dplyr]

-- PISA2012 data
In this analysis, the original dataset is provided by library 
